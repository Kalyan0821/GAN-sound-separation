...
class TrainOptions(BaseOptions):
	def __init__(self):
		...
		# model arguments
		self.parser.add_argument("--visual_pool", type=str, default="maxpool", help="avgpool/maxpool/conv1x1, for visual stream")
		...
		self.parser.add_argument("--consistency_loss_weight", default=1, type=float, help="weight for consistency loss")
