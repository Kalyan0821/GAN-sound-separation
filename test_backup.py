...
for vid_id in tqdm(range(num_Videos)):
	...
	while sliding_window_start + samples_per_window < audio_length:		
		...
		predicted_masks = pred_masks.permute(1,0,2,3)#.to(opt.device)
		#predicted_masks.to(audio_mix_mags.type())
		print(predicted_masks.type())
		print(audio_mix_mags.type())
		print(audio_mix_phases.type())
